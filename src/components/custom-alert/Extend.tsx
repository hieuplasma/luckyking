...
import MyAlert from "./CustomisableAlert";
...
interface CustomisableAlertProps {
    /**
    ...
    dismissable?: boolean;
    /**
     * Set a default icon for your warning messages
     */
    defaultWarningIcon?: React.ReactNode;
    /**
     * Set a default icon for your success messages
     */
    defaultSuccessIcon?: React.ReactNode;
    /**
     * Set a default icon for your error messages
     */
...
export class CustomisableAlert extends React.Component<CustomisableAlertProps> { 
    render() {
        return (
            <MyAlert {...this.props} />
        )
