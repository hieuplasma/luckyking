...
const lotteryType = LotteryType.Max3D
type NavigationProp = StackNavigationProp<StatisticalStackParamList, 'StatisticalMax3d'>;
type NavigationRoute = RouteProp<StatisticalStackParamList, 'StatisticalMax3d'>;

export interface StatisticalMax3dParamsList { }

export const StatisticalMax3dTab = React.memo(() => {

    const navigation = useNavigation<NavigationProp>();

    return (
        <View style={styles.container}>
            <ImageHeader navigation={navigation} title={"Thống kê Max3D/3D+"} />
