...
const lotteryType = LotteryType.Mega
type NavigationProp = StackNavigationProp<StatisticalStackParamList, 'StatisticalMega'>;
type NavigationRoute = RouteProp<StatisticalStackParamList, 'StatisticalMega'>;

export interface StatisticalMegaParamsList { }

export const StatisticalMegaTab = React.memo(() => {

    const navigation = useNavigation<NavigationProp>();

    return (
        <View style={styles.container}>
            <ImageHeader navigation={navigation} title={"Thống kê Mega 6/45"} />
