...
const flexRow = [1, 1, 1, 1]
const colorArr = [Color.keno, '#2E8DFE', '#08903E', '#5F52FE']

export const TableKenoBigSmall = React.memo(({ data }: TableProps) => {
                        ...
                        <TableWrapper style={styles.wraper}>
                            {
                                dataDisplay[0].map((cellData: any, cellIndex: number) => (
                                    <Cell
                                        ...
                                        key={cellIndex}
                                        data={cellData}
                                        textStyle={{ fontWeight: 'bold', color: Color.white, fontSize: 16, textAlign: 'center' }}
                                    />
                                ))
                            }
                        </TableWrapper>
