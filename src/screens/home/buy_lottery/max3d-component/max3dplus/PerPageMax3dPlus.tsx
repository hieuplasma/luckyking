...
interface PerPageMax3dPlusProps {
    hugePosition: number[],
    listNumber: any,
...
export const PerPageMax3dPlus = React.memo(({ hugePosition, listNumber, lottColor, bet, onChangeNumber, onChangeBet }: PerPageMax3dPlusProps) => {
    ...
    return (
        <View style={{ marginHorizontal: 8, width: windowWidth - 16 }}>
            <View style={{ height: 440, flexDirection: 'row', justifyContent: 'space-between' }}>
